...
function SideMenu({ isOpen, toggleMenu }) {
  ...
  return (
    <div className={`bg-gray-700 text-white w-64 space-y-2 py-2 fixed inset-y-0 left-0 transform ${isOpen ? 'translate-x-0' : '-translate-x-full'} md:translate-x-0 md:fixed transition duration-300 ease-in-out h-full`}
      ...
      <a href="#home" className="block py-2.5 px-4 rounded transition duration-200 hover:bg-gray-600">Home</a>
      <a href="#schedule" className="block py-2.5 px-4 rounded transition duration-200 hover:bg-gray-600">Match Schedule</a>
      <a href="#bets" className="block py-2.5 px-4 rounded transition duration-200 hover:bg-gray-600">My Bets</a>
      <a href="#points" className="block py-2.5 px-4 rounded transition duration-200 hover:bg-gray-600">My Points</a>
      <a href="#analytics" className="block py-2.5 px-4 rounded transition duration-200 hover:bg-gray-600">Analytics</a>
