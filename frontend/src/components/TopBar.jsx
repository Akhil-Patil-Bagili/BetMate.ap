                ...
                <div className="relative">
                    ...
                    {isSubmenuOpen && (
                        <div className="absolute right-0 w-48 bg-gray-700 mt-2 py-2 rounded shadow-lg z-50">
                            <a href="#profile" className="block px-4 py-2 text-sm text-white hover:bg-gray-600">Profile</a>
                            <a href="#logout" className="block px-4 py-2 text-sm text-white hover:bg-gray-600">Logout</a>
                        </div>
                    )}
                </div>
            </div>
